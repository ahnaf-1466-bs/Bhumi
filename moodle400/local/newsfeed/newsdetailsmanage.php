...
$templatecontext = (object)[
    ...
    'val' => $val,
    'back' => $back,
    'backurl' => new moodle_url('../../admin/search.php#linkmodules'),
...
echo $OUTPUT->render_from_template('local_newsfeed/newsdetailsmanage', $templatecontext);
