...
class auth extends \auth_plugin_base {
    ...
    public function complete_login(client $client, $redirecturl) {
        ...
        // redirect($redirecturl);
         // Generating Token for login in angular and redirecting to the vumi_auth URL.
        ...
        $sql = "SELECT  *  
                ...
                WHERE name = 'Moodle mobile web service'" ;

        $service = $DB->get_record_sql($sql, ['name' => 'Moodle mobile web service']);
        ...
        $config_vumi = get_config('auth_vumi_auth', 'redirect_url');
        redirect($config_vumi.'?token='.$result['token']);
    }
