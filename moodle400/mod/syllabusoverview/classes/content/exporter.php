 ...
 */
namespace mod_syllabusoverview\content;
...
class exporter extends abstract_mod_exporter {
    ...
    /**
     * Get the exportable items for mod_syllabusoverview.
     *
    ...
    public function get_exportables(bool $includeuserdata = false): array {
        ...
        $contentitems[] = new exportable_textarea(
            $this->get_context(),
            $this->get_component(),
            get_string('content', 'mod_syllabusoverview'),

            // Content is in the 'content' field of the 'page' table.
            $this->get_modname(),
            'content',

            // The record ID in the database is the id.
            $this->cm->instance,
            'contentformat',

            // The mod_syllabusoverview content has files in 'content/0', and the itemid (0) is present in the URL.
            'content',
            0,
            0
        );
