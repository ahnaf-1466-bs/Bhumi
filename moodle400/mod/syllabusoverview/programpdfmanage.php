...
$PAGE->set_title(get_string('manage_programpdf', 'mod_syllabusoverview'));
$PAGE->set_heading(get_string('manage_programpdf', 'mod_syllabusoverview'));
$PAGE->requires->css('/mod/syllabusoverview/styles.css');

echo $OUTPUT->header();
$messages = get_pdfurl_for_program($courseid);
...
$templatecontext = (object)[
    'messages' => $messages,
    'featureurl' => new moodle_url('/mod/syllabusoverview/programpdf.php?id='.$courseid),
